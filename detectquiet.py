...
def app_callback(pad, info, user_data):
    ...
    if user_data.use_frame:
        ...
        if current_time in time_list and len(label) > 3:
...
class GStreamerDetectionApp(GStreamerApp):
    ...
    def get_pipeline_string(self):
        ...
        pipeline_string += f"fpsdisplaysink video-sink=fakesink name=hailo_display text-overlay=false signal-fps-measurements=true "
